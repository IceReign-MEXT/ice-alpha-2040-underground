...
http.createServer((req, res) => {
  res.write("Vanguard System Active");
  res.end();
}).listen(process.env.PORT || 10000);
console.log("📡 Heartbeat server listening on port " + (process.env.PORT || 10000));
// ------------------------------------------------
...
connection.onAccountChange(architectWallet, (info) => {
    ...
    if (sol >= 0.014) {
        bot.sendMessage(channelId, "🔥 **THRESHOLD REACHED:** 0.014 SOL Detected. Metadata Forge is ready.");
    }
}, "confirmed");
